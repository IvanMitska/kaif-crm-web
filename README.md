...
```bash
git clone https://github.com/your-org/sintara-crm.git
cd sintara-crm
```
...
- **Prisma Studio**: `pnpm --filter @sintara-crm/backend prisma studio`
...
pnpm --filter @sintara-crm/backend test

# Запустить тесты frontend
pnpm --filter @sintara-crm/frontend test
...
```bash
pnpm --filter @sintara-crm/backend start:debug
```
...
- Email: support@sintara-crm.com
- Telegram: @sintara_crm_support

---

Разработано командой Sintara CRM
